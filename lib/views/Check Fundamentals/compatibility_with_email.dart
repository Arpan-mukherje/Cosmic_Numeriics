...
class CompatibilityWithEmail extends StatefulWidget {
  const CompatibilityWithEmail({Key? key}) : super(key: key);

  @override
  State<CompatibilityWithEmail> createState() => _CompatibilityWithEmailState();
}

class _CompatibilityWithEmailState extends State<CompatibilityWithEmail> {
  ...
  emailCompatibilityCheck(int emailNumber) {
    if (numerologyNumber == emailNumber ||
        emailNumber == 3 ||
        emailNumber == 6 ||
        emailNumber == 9 ||
        emailNumber == 1) {
  ...
  int getSingleDigitFromEmail(String email) {
    ...
    for (int i = 0; i < localPart.length; i++) {
      String char = localPart[i].toLowerCase();
            ...
            Stack(
              ...
              children: [
                DecorativeAppBar(
                  ...
                  extra:
                      appbar("assets/email.png", "Compatibility", context, () {
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        ...
                        "Check Compatibility With Your Email",
                        style: TextStyle(
                        ...
                        child: GradientElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (isValidEmail(enteredEmail)) {
                              var emailNumber =
                                  getSingleDigitFromEmail(enteredEmail);
                              emailCompatibilityCheck(emailNumber);
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) =>
